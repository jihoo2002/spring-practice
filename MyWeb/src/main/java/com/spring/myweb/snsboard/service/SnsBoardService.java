...
public class SnsBoardService {
	...
	private final ISnsBoardMapper mapper; //매퍼 주입
...
//        //fileRealName -> 실제 파일명
//		
//		String filefullName = uuid + fileExtension;
//		File saveFile = new File(uploadPath + "/" + fileLoca + "/" + filefullName);
//		try {
